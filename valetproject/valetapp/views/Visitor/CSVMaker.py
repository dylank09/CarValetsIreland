...
class CSVMaker:
    ...
    def create_CSV(self):
        header = ['emails', 'money', 'money_in_store', 'all_stores', 'all_valets', 'all_staff', 'all_valets']
        data = [CSVMaker.get_emails(), CSVMaker.get_money(), CSVMaker.get_money_in_store(), CSVMaker.get_all_stores(), CSVMaker.get_all_valets(), CSVMaker.get_all_staff(), CSVMaker.get_all_valets()]
